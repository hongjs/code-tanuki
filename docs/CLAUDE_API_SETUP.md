...
This document explains how to configure Anthropic's Claude API access for CodeOwl's AI-powered code review functionality.

## Overview

Claude API (Anthropic) is the **core requirement** for CodeOwl. It powers the AI code review functionality that analyzes pull requests and provides intelligent feedback.

## Required Claude API Operations

CodeOwl uses the following Anthropic API operations:
...
2. **Create New Key**
   - Click **"Create Key"**
   - Enter a name: `CodeOwl PR Review Tool`
   - Click **"Create Key"**
...
## Supported Models in CodeOwl

CodeOwl supports three Claude 4 models with different performance characteristics:
...
| **Haiku 4** | `claude-haiku-4-20250514` | Fastest | 4,096 | Simple reviews, quick feedback | Lowest |
...
| `CLAUDE_MAX_TOKENS` | No | `4096` | Maximum output tokens |
...
6. Open an issue: https://github.com/hongjs/codeowl/issues
